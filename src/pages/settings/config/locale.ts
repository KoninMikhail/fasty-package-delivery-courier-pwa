export const translationNS = 'page:settings';

export const PAGE_HEADING = 'page.heading';
export const SECTION_LEGAL_TITLE = 'section.legal.title';
export const SECTION_LEGAL_PRIVACY_POLICY = 'section.legal.privacy';
export const SECTION_LEGAL_TERMS_OF_USE = 'section.legal.terms';
