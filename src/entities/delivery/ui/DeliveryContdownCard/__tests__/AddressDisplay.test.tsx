...
vi.mock('react-i18next', async () => {
    const originalModule =
        await vi.importActual<typeof import('react-i18next')>('react-i18next'); // Dynamically import the actual react-i18next module.
    ...
    return {
        ...
        useTranslation: () => ({
            ...
            t: (key: string) => {
                ...
                if (key === 'delivery.label.address.notFound')
